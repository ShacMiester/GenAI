...
@Component({
  selector: 'app-vehicle-table-secondary',
  standalone: true,
  ...
  template: `
    <div class="vehicle-table-container">
      <app-reusable-table 
        ...
        [headerTitle]="'Evening Shift'"
        [headerDescription]="'08:00 PM - 04:00 AM'"
        (statusChange)="onStatusChange($event)"
      />
    </div>
  `,
  styleUrls: ['./vehicle-table-secondary.component.scss']
})
export class VehicleTableSecondaryComponent implements OnInit {
